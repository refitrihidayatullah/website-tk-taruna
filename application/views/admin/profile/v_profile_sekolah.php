            ...
            <div class="card-body">
                <div class="row mt-4">
                    <div class="col-9">
                        ...
                        <h6 class="card-subtitle">Berisi informasi yang akan ditampilkan ke user.
                        </h6>
                ...
                <div class="row mt-4">
                    <div class="col-9">
                        <h4 class="card-title ">Content Profile</h4>
                        <h6 class="card-subtitle">Berisi informasi pada profile sekolah yang akan ditampilkan ke user.
                        </h6>
